---
name: test
description: Run tests and achieve 100% coverage on new code, writing additional tests if needed. Use after writing code, before committing.
---
...
5. If feature requires internet/latency (e.g., LLM calls), also run `make test-all`
