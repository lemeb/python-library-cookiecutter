...
Load `dev/documentation.md` for detailed guidance on docstrings and markdown formatting.
...
3. If new module was created: ensure `docs/api/` entry AND `mkdocs.yml` nav updated
